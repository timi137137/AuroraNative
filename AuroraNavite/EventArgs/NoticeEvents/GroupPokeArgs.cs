namespace AuroraNavite.EventArgs
{
    ...
    /// </summary>
    public abstract class GroupPokeArgs : PokeEventArgs
    {
        #region --构造函数--
        ...
        public GroupPokeArgs(string PostType, string NoticeType, string SubType, long UserID, long TargetID) : base(0, 0, PostType, NoticeType, SubType, UserID, TargetID) { }
