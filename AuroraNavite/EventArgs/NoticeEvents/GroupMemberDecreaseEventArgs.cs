namespace AuroraNavite.EventArgs
{
    ...
    /// </summary>
    public sealed class GroupMemberDecreaseEventArgs : GroupNoticeArgs
    {
        #region --构造函数--
        ...
        public GroupMemberDecreaseEventArgs(long TimeStamp, long SelfID, string PostType, string NoticeType, string SubType, long GroupID, long OperatorID, long UserID) : base(TimeStamp, SelfID, PostType, NoticeType, SubType, GroupID, OperatorID, UserID) { }
